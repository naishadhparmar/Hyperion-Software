...
void ip_data_callback(geometry_msgs::PointStamped msg)
{
  std_msgs::Float64 data_sideward;
  data_sideward.data = msg.point.y;
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber ip_data_sub = nh.subscribe<geometry_msgs::PointStamped>("/threshold/center_coordinates", 1000, &ip_data_callback);
